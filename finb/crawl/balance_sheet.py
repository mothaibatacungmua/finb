...
def get_balance_sheet(symbol, from_year=None, to_year=None):
    furl = f"https://www.bsc.com.vn/api/Data/Finance/LastestFinancialReports?symbol={symbol}&type=1&year=%d&quarter=4&count=5"
